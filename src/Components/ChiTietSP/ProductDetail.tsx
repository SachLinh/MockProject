...
function ProductDetail() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div key={detailProduct?.id} className='font-sans 2xl:w-[1300px]  xl:w-[1200px] lg:w-[1000px] md:w-[700px] sm:w-[600px] w-[350px]'>
			...
			<div className=' pb-5  flex justify-center w-full'>
				<div className='grid grid-cols-1 w-full lg:grid-cols-3 gap-5 mt-5 text-center items-center'>
