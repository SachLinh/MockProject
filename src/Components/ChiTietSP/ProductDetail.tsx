					...
					<div className=''>
						...
						<div className='flex my-4 text-center'>
							<p className='text-[18px] font-bold text-red-500'>
								33.000.000 <span className='text-[14px]'>₫</span>
							</p>
							<p className='text-[14px] text-gray-400 ml-5 mt-[2px] line-through'>
								37.990.000 ₫
							</p>
						</div>
						<div className='grid grid-cols-3 gap-2'>
							<div className='price-memory'>
								...
								<p>
									34.490.000 <span className='text-[10px]'>₫</span>
								</p>
							</div>
							<div className='price-memory'>
								<p className='font-bold text-gray-800 '>1TB</p>
								<p>
									46.000.000 <span className='text-[10px]'>₫</span>
								</p>
							</div>
							<div className='price-memory'>
								<p className='font-bold text-gray-800 '>512GB</p>
								<p>
									39.000.000 <span className='text-[10px]'>₫</span>
								</p>
							</div>
							<div className='price-memory'>
								<p className='font-bold text-gray-800 '>256GB</p>
								<p>
									33.000.000 <span className='text-[10px]'>₫</span>
								</p>
							</div>
							<div className='price-memory'>
								<p className='font-bold text-gray-800 '>128GB</p>
								<p>
									29.550.000 <span className='text-[10px]'>₫</span>
								</p>
							</div>
						</div>
						<div>
							...
							<div className='grid grid-cols-3 gap-2'>
								...
								<button className='price-color '>
									<div className='flex'>
										<img
											className='w-[38px]'
											src='https://image.cellphones.com.vn/358x/media/catalog/product/i/p/iphone_13-_pro-max_2_1.jpg'
											alt=''
										/>
										<div>
								...
								<button className='price-color '>
									<div className='flex'>
										<img
											className='w-[38px]'
											src='https://image.cellphones.com.vn/358x/media/catalog/product/i/p/iphone_13-_pro-4_6.jpg'
											alt=''
										/>
										<div>
								...
								<button className='price-color '>
									<div className='flex'>
										<img
											className='w-[38px]'
											src='https://image.cellphones.com.vn/358x/media/catalog/product/i/p/iphone_13-_pro-5_6.jpg'
											alt=''
										/>
										<div>
					...
					<div className='rounded-xl border-[1px] h-fit'>
						...
						<div className=' text-[16px] m-3 border-[1px] border-gray-300 rounded-xl'>
							...
							<div className='grid grid-cols-3 py-2 px-2 '>
								...
								<div className='col-span-2 '>OLED</div>
							</div>
