...
function ProductDetail() {
  ...
  return (
    <div className="2xl:w-[1300px] relative xl:w-[1200px] lg:w-[1000px] md:w-[700px] sm:w-[600px] w-[350px]">
      <div key={detailProduct?.id} className="font-sans w-full">
              ...
              <div className="mt-5">
                <Link to={"/cart"}>
                  <div
                    ...
                    onClick={storage}
                  >
                    <h1 className="font-bold lg:text-[18px] text-[50px] ">
                      MUA NGAY
                    </h1>
                    <p className="lg:text-[18px] text-[50px]">
              ...
              <div className="mt-3 border-[1px] rounded-xl border-gray-300 ml-3 mr-3 lg:ml-0 lg:mr-0">
                ...
                <div className="my-3 mx-2">
                  ...
                  <div className="flex">
                    <BsCheckCircle className="text-green-600 mt-1 lg:text-[17px] text-[80px]" />
                    <p className="lg:text-[14px] text-[50px] ml-2">
                      Giảm thêm 5% (tối đa 500k) khi thanh toán qua ví Moca trên
                      ứng dụng Grab
                    </p>
                  </div>
                </div>
