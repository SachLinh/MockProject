            ...
            <div className="rounded-2xl shadow-xl border-[1px] border-gray-300 h-max">
                <Link to="">
                    <div className="grid grid-flow-row grid-cols-5 m-2 p-2 nav nav-active cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                        <p className="font-semibold text-xl col-start-2 col-span-4">Trang chủ</p>
                    </div>
                </Link>
                <Link to="lich-su-mua-hang">
                    <div onClick={setActiveNav} className="grid grid-flow-row grid-cols-5 m-2 p-2 nav nav-non-active cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                        </svg>
                        <p className="font-semibold text-xl col-start-2 col-span-4">Lịch sử mua hàng</p>
                    </div>
                </Link>
                <Link to="tai-khoan">
                    <div className="grid grid-flow-row grid-cols-5 m-2 p-2 nav nav-non-active cursor-pointer">
                        ...
                        <p className="font-semibold text-xl col-start-2 col-span-4">Tài khoản của bạn</p>
                    </div>
                </Link>
                <Link to="ho-tro">
                    <div className="grid grid-flow-row grid-cols-5 m-2 p-2 nav nav-non-active cursor-pointer">
                        ...
                        <p className="font-semibold text-xl col-start-2 col-span-4">Hỗ trợ</p>
                    </div>
                </Link>
                <Link to="/Smember" onClick={() => firebase.auth().signOut()}>
                    <div className="grid grid-flow-row grid-cols-5 m-2 p-2 nav-non-active cursor-pointer">
                        ...
                        <p className="font-semibold text-xl col-start-2 col-span-4">Thoát tài khoản</p>
                    </div>
                </Link>
            </div>
            <Routes>
