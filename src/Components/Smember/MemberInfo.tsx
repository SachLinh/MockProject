...
function MemberInfo({ }: Props) {
  return (
    <div className="mt-20 w-5/6 mx-auto grid grid-flow-row grid-cols-4">
      <div className="rounded-2xl shadow-xl border-[1px] border-gray-300">
        <div className="grid grid-flow-row grid-cols-5 m-2 p-2 border-[1px] border-red-500 rounded-xl bg-[#fee]">
        ...
        <div className="grid grid-flow-row grid-cols-5 m-2 p-2">
