...
export default function Footer() {
	return (
		<div className=''>
			<div className='font-Roboto text-[#444444] flex flex-row justify-between items-start w-full px-[75px] py-[15px] shadow-inner shadow-[#e4e0e0] text-[12px]'>
				<div>
					<ul className='mr-[15px] '>
						<li className='mb-[8px]'>
							<p className='text-[18px] font-bold'>Tìm cửa hàng</p>
						</li>
						<li className='mb-[5px]'>
				...
				<div className='mr-[15px]'>
					...
					<div>
						<p className='mt-[15px] mb-[5px] text-[18px] font-bold'>
			...
			<div className='font-Roboto text-[#444444] px-[75px] py-[15px] bg-[#f8f8f8] text-[10px]'>
				<div>
					...
					<p className='w-full text-center mt-[15px]'>
						...
						Địa chỉ: 350-352 Võ Văn Kiệt, Phường Cô Giang, Quận 1, Thành
						phố Hồ Chí Minh, Việt Nam. Điện thoại: 028.7108.9666.
					</p>
