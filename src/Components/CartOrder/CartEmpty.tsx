...
function CartEmpty({ }: Props) {
    return (
        <div className='mx-auto mt-10 text-center'>
            ...
            <h3 className='mt-10 text-[#444] text-xl'>Không có sản phẩm nào trong giỏ hàng, vui lòng quay lại</h3>
            <Link to="/">
                <div className='mx-auto mt-10 w-1/4 bg-red-600 rounded-lg cursor-pointer'>
