    ...
    return (
        <div className="w-5/12 h-96 mx-auto mt-3">
            ...
            <div className="mt-3 px-2 py-3 grid grid-flow-row grid-cols-3 border border-solid rounded-xl  relative shadow-lg">
                <div className="">
                    <img src="https://image.cellphones.com.vn/200x/media/catalog/product/s/m/sm-f926_zfold3_5g_openback_phantomsilver_210611_2.jpg" alt="product in cart" />
                </div>
                <div className="col-start-2 col-span-2">
                    ...
                    <div className="grid grid-flow-row grid-cols-4">
                        ...
                        <div className="bg-red-600 w-10/12 p-1 rounded-lg">
                            <p className="text-sm text-white font-semibold">Giảm 14%</p>
                        </div>
                    </div>
                    <div>
                    ...
                    <div className="bg-[#f6f6f6] mt-2 pt-2 pb-4 pl-2 rounded-lg">
                        ...
                        <ul className="pl-4 text-red-500">
                            <li className="list-disc text-[15px] text-black">Gói dịch vụ ưu tiên cao cấp và phòng chờ hạng thương gia</li>
                        </ul>
                    </div>
                </div>
                <div className="absolute top-1 right-1">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500 font-bold cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
